...
export function renderAngularMaterial(doc: UiDocument, className: string): RenderedAngularComponent {
  ...
  const versionComment = [
    '/**',
    ' * Generated by qml-ng',
    ` * Generator version: ${doc.version.generatorVersion}`,
    ` * Schema version: ${doc.version.schemaVersion}`,
    ` * Generated at: ${doc.version.generatedAt}`,
    ' *',
  ...
  const htmlVersionComment = `<!-- Generated by qml-ng v${doc.version.generatorVersion} (schema v${doc.version.schemaVersion}) at ${doc.version.generatedAt} -->`;
