...
export function parseQmlWithDiagnostics(source: string, options: QmlParseOptions = {}): QmlParseResult {
...
export function parseQml(source: string, options: QmlParseOptions = {}): QmlDocument {
  ...
  // For backward compatibility, throw on errors or return document
